...
public class BoulderController {
	...
	public void prime() {
		/*
		 * switch(primeState){ case 0: time.reset(); primeState = 1; break;
		 * 
		 * case 1: shooter.setLoadWheels(0.5); if(time.get() > 0.3){ primeState
		 * = 2; time.reset(); } break;
		 * 
		 * case 2: //shooter.setLoadWheels(-0.7); shooter.setLoadWheels(-0.4);
		 * //if (time.get() >= 0.22) {//was .42 if(!ballSensor.get() ||
		 * time.get() > 2){ primeState = 3; time.reset(); } break;
		 * 
		 * case 3: shooter.setLoadWheels(0); shooter.prime(); primeState = 4;
		 * break;
		 * 
		 * case 4: shooter.prime(); break; }
		 */
		shooter.prime(1);
