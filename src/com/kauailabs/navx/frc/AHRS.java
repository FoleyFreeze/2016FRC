...
public class AHRS extends SensorBase implements PIDSource, LiveWindowSendable {
	 ...
	 * href=http://navx-mxp.kauailabs.com/installation/orientation-2/>
	 * Orientation</a> page.
	 */
	 ...
	 * by the sensor. Pitch is a measure of rotation around the X Axis.
	 * 
	 ...
	 * the sensor. Roll is a measure of rotation around the X Axis.
	 * 
	 ...
	 * <p>
	 * 
	 * @return Returns true if a valid update has been recently received from
	 *         the sensor.
	 */
	 ...
	 * sensor. This count should increase at the same rate indicated by the
	 ...
	 * values of the X and Y axis exceed a "motion threshold", the motion state
	 * is indicated.
	 * <p>
	 * 
	 ...
	 * whether the change in yaw over the last second exceeds the
	 * "Rotation Threshold."
	 * <p>
	 ...
	 * href=https://en.wikipedia.org/wiki/Quaternions_and_spatial_rotation>
	 * definition</a>.
	 * 
	...
	/**
	 * Each time new linear acceleration samples are received, this function
	 * should be invoked. This function transforms acceleration in G to
	 * meters/sec^2, then converts this value to Velocity in meters/sec (based
	 * upon velocity in the previous sample). Finally, this value is converted
	 * to displacement in meters, and integrated.
	 * 
	 * @return none.
	 */
	 ...
	 * of acceleration values from MEMS accelerometers which yield "noisy"
	 * values. The resulting velocities are not known to be very accurate.
	 * 
	...
	/**
	 * Returns the version number of the firmware currently executing on the
	 * sensor.
	 * <p>
